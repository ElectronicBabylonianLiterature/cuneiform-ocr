...
from efficient_net.data_sample import DataSample
from efficient_net.utils import cat_batch_labels, batch_label_to_onehot, tensor_split

MultiTaskDataSample = Never
...
class ClsDataPreprocessor(BaseDataPreprocessor):
    ...
    def __init__(self,
        ...
        if batch_augments:
            raise NotImplementedError("Batch Augments not implemented")
            """
